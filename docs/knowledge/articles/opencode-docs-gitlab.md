...
source_file: "/Users/halapinvv/Documents/Agents/CodeAI/docs/opencode-docs/10-gitlab.md"
imported: 2026-07-28
...
Дополнительные сведения и варианты использования см. в документации \]([https://gitlab.com/explore/catalog/nagyv/gitlab-opencode](https://gitlab.com/explore/catalog/nagyv/gitlab-opencode)) для этого компонента.
