...
source_file: "/Users/halapinvv/Documents/Agents/CodeAI/docs/opencode-docs/16-keybinds.md"
imported: 2026-07-28
...
-   [Обзор](#_top)
-   [Клавиша Leader](#клавиша-leader)
-   [Отключение привязки клавиш](#отключение-привязки-клавиш)
-   [Шорткаты в Desktop-приложении](#шорткаты-в-desktop-приложении)
...
Отменить всплывающие окна/прервать выполнение ответа
